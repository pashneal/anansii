...
pub const LEFT_OVERFLOW_MASK: u64 = 0x8080808080808080;
...
impl MiniBitGrid {
    ...
    pub fn ladybug_moves(&self, location: MiniBitGridLocation) -> MiniGrid {
        ...
        for loc in climb_down {
            grid[loc.board_index] |= AxialBitboard::from_u64(loc.mask);
        }
